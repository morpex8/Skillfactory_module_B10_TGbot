...
def start(message: telebot.types.Message):
    text = 'Бот конвертирует из одной валюты в другую.\n\nСписок доступных валют: /values\n\
Для конвертации, используйте команду /convert или напишите боту в следующем формате:\n\n<имя валюты> \
...
{keys[curr_from]} = {conv} {keys[curr_to]}'
